...
static volatile ptrTIMERFunctionCallback g_TIMER_ptr = NULL;
...
void TIMER_sysTick_setCallBack(ptrTIMERFunctionCallback OS_sysTickFunction)
{
	g_TIMER_ptr = OS_sysTickFunction;
}
